...
private:
  ...
  insert_hash_variable(llvm::Function *F,
                       llvm::BasicBlock *initialization_block);
  short_range_path_oh &
  determine_path_processing_settings(llvm::Function *F,
                                     FunctionOHPaths::OHPath &path);
  void update_statistics_with_data_dep_instructions(
  ...
  bool can_instrument_instruction(llvm::Function *F, llvm::Instruction *I,
  ...
  bool process_path_block(llvm::Function *F, llvm::BasicBlock *B,
                          ...
                          const SkipFunctionsPred &skipInstructionPred,
                          bool &local_hash_updated, int path_num,
                          InstructionSet &skipped_instructions,
                          bool hash_branch_inst);
  bool process_block(llvm::Function *F, llvm::BasicBlock *B,
                     llvm::Value *local_hash_value, bool insert_assert,
                     const SkipFunctionsPred &skipInstructionPred,
                     bool &local_hash_updated,
                     InstructionSet &skipped_instructions, bool hash_branches);
  bool isUsingGlobal(
      llvm::Value *value,
  ...
  bool can_protect_loop_path(llvm::Function *F,
                             ...
                             bool &is_arg_reachable_loop,
                             bool &is_glob_reachable_loop);
  bool can_protect_loop_block(llvm::BasicBlock *B, bool &data_dep_loop,
  ...
  void extend_loop_path(llvm::Function *F, FunctionOHPaths::OHPath &path,
                        llvm::Loop *path_loop);
  ...
  bool insertHash(llvm::Instruction &I, llvm::Value *v, llvm::Value *hash_value,
                  bool before, bool isLocal);
  bool instrumentInst(llvm::Instruction &I, llvm::Value *hash_to_update,
                      bool is_local_hash);
  ...
  void insertAssert(llvm::Instruction &I, llvm::Value *hash_value,
                    bool short_range_assert, llvm::Constant *assert_F);
  void doInsertAssert(llvm::Instruction &I, llvm::Value *hash_value,
                      bool short_range_assert, llvm::Constant *assert_F);
...
private:
  ...
  std::unordered_map<llvm::Function *, MemoryDefinitionData>
      m_function_memory_defining_blocks;
  std::unordered_map<llvm::Function *, std::vector<short_range_path_oh>>
      m_function_oh_paths;
  // It's more efficient to collect skipped instructions
  std::unordered_map<llvm::Function *, InstructionSet>
      m_function_skipped_instructions;
  std::unordered_map<llvm::Function *, InstructionSet>
      m_argument_reachable_instructions;
  std::unordered_map<llvm::Function *, InstructionSet>
      m_global_reachable_instructions;
