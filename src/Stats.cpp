...
bool verifyInstructions(const oh::OHStats::InputDependencyAnalysisType &input_dependency_info,
...
bool verifyInstructions(const oh::OHStats::InputDependencyAnalysisType &input_dependency_info,
                        const std::unordered_set<llvm::Instruction *> &instructions) {
...
void OHStats::addSCShortRangeProtectedProtectedGuardInstr(llvm::Instruction *I,
                                                          int checkeeSize,
...
bool OHStats::verify(const InputDependencyAnalysisType &input_dependency_info) {
...
void OHStats::dumpJson(const std::string &filePath) {
